...
namespace eosiosystem {
   ...
   // static const time_point gbm_initial_time(eosio::seconds(1561939200+365*24*60*60*0+15897656));     // July 1st 2019 00:00:00
   static const time_point gbm_initial_time(eosio::seconds(1561939200+365*24*60*60*0+15984000));     // July 1st 2019 00:00:00
